...
#define STRING_CONFIG_H_AUTHOR "(Doyle4 Artillery Genius ABL - MKS SGEN L V2.0)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  15.8341
    #define DEFAULT_Ki   0.8502
    #define DEFAULT_Kd 73.7214
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 49.3732
  #define DEFAULT_bedKi 4.5948 
  #define DEFAULT_bedKd 353.6930
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 440.1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 36.10, -36, 0 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN P1_27               // Use internal pullup for filament runout pins.
